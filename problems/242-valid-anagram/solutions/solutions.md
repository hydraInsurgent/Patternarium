...
**Code:** [sort-compare.cs](sort-compare.cs)
...
**Code:** [hashmap-frequency.cs](hashmap-frequency.cs)
...
**Code:** [array-frequency.cs](array-frequency.cs)
**Time:** O(n) | **Space:** O(1)
...
**Code:** [span-frequency.cs](span-frequency.cs)
**Time:** O(n) | **Space:** O(1)
...
- Preprocessing - Sort to Expose Structure (Approach 1) - sort both strings so anagrams become identical, then compare index by index
- HashMap - Frequency Count (Approaches 2, 3, 4) - count occurrences in s, cancel with t, verify all counts reach zero
