...
approaches:
  ...
  - name: Two-Pointer Converging/Diverging
    file: two-pointer-converging.cs
...
**Code:** [prefix-suffix-arrays.cs](prefix-suffix-arrays.cs)
**Time:** O(n) | **Space:** O(n)
...
**Code:** [two-pointer-converging.cs](two-pointer-converging.cs)
...
**Code:** [two-pass-sequential.cs](two-pass-sequential.cs)
**Time:** O(n) | **Space:** O(1) extra
...
- Prefix/Suffix Decomposition (Approaches 2, 3, 4) - the core insight: "product of everything except self" decomposes into "left product * right product"
- Two Pointers - Converging/Diverging (Approach 3) - pointers start at edges, converge depositing partial products, then diverge completing each position
- Preprocessing - Build Derived Data (Approach 2) - precompute left and right product arrays before building the final answer
- Multi-Pass Construction (Approaches 3, 4) - use the output array as working space, depositing one half of the answer per pass
