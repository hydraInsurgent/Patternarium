...
- [Linear Scan - Neighbor Comparison](../../patterns/linear-scan.md) (Approach 1) - after sorting, scan comparing each element to the previous to detect consecutive runs and duplicates
- [HashMap - Complement Lookup / HashSet - Existence Lookup](../../patterns/hashmap.md) (Approach 2) - use n-1 absence as the sequence start signal, extend runs with O(1) contains checks
- [Presence Array - Bucket Marking](../../patterns/presence-array.md) (Approach 3) - map values to boolean array indices using (num - min) offset, scan for longest consecutive true run
