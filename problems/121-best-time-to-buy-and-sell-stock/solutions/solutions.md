...
**Code:** [running-state.cs](running-state.cs)
**Time:** O(n) | **Space:** O(1)
...
- Linear Scan - Running State (Approach 2) - Single pass maintaining running minimum price and computing max profit at each step, summarizing past data into two variables instead of storing it.
