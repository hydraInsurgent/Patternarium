...
- Guiding them through multiple approaches
- Extracting the patterns behind each approach
- Storing patterns as reusable mental tools

## Who It Is For

Someone who is learning DSA for the first time or re-learning it after gaps. They understand basic programming but have not yet built pattern recognition instincts. They want to understand, not just pass interviews.
...
1. **Guided problem solving** - AI walks alongside the user, nudging not telling
2. **Solution storage** - code saved per problem, per approach
3. **Pattern catalogue** - every solution maps to a pattern, building a personal library

## User Journey

1. User pastes a problem statement
2. AI explains the problem and asks for the user's approach
3. AI nudges toward brute force, then optimization, then alternatives
4. Each approach is saved as its own solution file
5. After solving, AI extracts the pattern used
6. Pattern is added to the library with examples
7. User reflects and writes notes
8. LESSONS.md is updated for recurring mistakes
